    ...
    render() {
        return (
            <section className="section-title container">
                ...
                <div>
                <a href="https://github.com/Kaynalem/katelyn-lopes/raw/master/src/assets/KatelynLopes.pdf" className="text-light text-decoration-none"><FontAwesomeIcon icon={faDownload} size="2x" alt="Download Resume"/></a>
                </div>
